...
async fn main() -> Result<()> {
    ...
    let threads = Arc::new(Mutex::new(cli.threads.unwrap_or(num_cpus::get())));
    ...
    let host = index["default"]["cdnList"][0]["url"].as_str().unwrap();
    ...
    Ok(println!("All resources downloaded!"))
}
